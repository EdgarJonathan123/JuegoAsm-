	...
	LimiteIzquierdo word	5d  			;margen Izquierdo
	LimiteDerecho	word	314d			;margen derecho
	LimiteSuperior	word	21d				;margen superior
	LimiteInferior	word	187d			;margen inferior
